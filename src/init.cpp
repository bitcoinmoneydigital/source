...
void Shutdown()
{
    ...
    RenameThread("bitcoinmoney-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcoinmoneydigital/source>";
    const std::string URL_WEBSITE = "<https://bitcoinmoney.digital>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("bitcoinmoney-loadblk");
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the "
                  "current working directory '%s'. This is fragile, because if bitcoinmoney is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if bitcoinmoney is started while in a temporary directory.\n",
