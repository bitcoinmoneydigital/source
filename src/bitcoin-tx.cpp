...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitcoinmoney-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcoinmoney-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinmoney transaction") + "\n" +
              "  bitcoinmoney-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinmoney transaction") + "\n" +
              "\n";
