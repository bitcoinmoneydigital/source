...
#if defined(NDEBUG)
# error "BitcoinMoney cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "BitcoinMoney Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("bitcoinmoney-scriptch");
