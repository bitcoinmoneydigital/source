...
"""Verify that starting bitcoinmoney with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinmoney with -h for help text")
        ...
        self.log.info("Start bitcoinmoney with -version for version information")
